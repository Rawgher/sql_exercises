...
SELECT app_name FROM analytics WHERE price > .10 AND price < 1 ORDER BY reviews LIMIT 10;
...
-- 15. Find the app that has the highest proportion of min_installs to reviews, among apps that have been installed at least 100,000 times. Display the name  --
